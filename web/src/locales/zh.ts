export default {
  translation: {
    ...
    login: {
      sso: {
        loadingTitle: '正在登录',
        loadingDescription: '正在通过统一身份认证，请稍候。',
        failedTitle: '暂时无法进入',
        noAccess: '你还没有知识库平台的访问权限，请联系管理员授权。',
        inactive: '当前账户已停用，请联系管理员。',
        expired: '本次登录已失效，请重新尝试。',
        configurationError: '统一登录配置暂时不可用，请联系管理员。',
        recoveryFailed: '未能恢复登录状态，请重试。',
        serviceUnavailable: '登录服务暂时不可用，请稍后重试。',
        failed: '统一身份认证未完成，请重试。',
        retry: '重新登录',
        portal: '返回门户',
        logoutFailed: '退出未完成，请检查网络后重试。',
      },
      loginTitle: '登录账户',
      signUpTitle: '创建账户',
      login: '登录',
